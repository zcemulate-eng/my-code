          ...
          <Grid container spacing={2}>
            <Grid size={{ xs: 12, md: 4 }}>
              <FormControl fullWidth size="small">
                ...
                {/* @ts-expect-error: MUI Select React 19 compatibility */}
                <Select
                  labelId="filter-level-label"  // 👈 新增 labelId
                  id="filter-level-select"      // 👈 新增 id
                  multiple
            ...
            <Grid size={{ xs: 12, md: 4 }}>
              <FormControl fullWidth size="small">
                ...
                {/* @ts-expect-error: MUI Select React 19 compatibility */}
                <Select
                  labelId="filter-country-label"  // 👈 新增 labelId
                  id="filter-country-select"      // 👈 新增 id
                  multiple
            ...
            <Grid size={{ xs: 12, md: 4 }}>
              <FormControl fullWidth size="small">
                ...
                {/* @ts-expect-error: MUI Select React 19 compatibility */}
                <Select
                  labelId="filter-city-label"  // 👈 新增 labelId
                  id="filter-city-select"      // 👈 新增 id
                  multiple
